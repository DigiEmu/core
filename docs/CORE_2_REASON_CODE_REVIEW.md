...
- `MISSING_REFERENCE` remains pending because it is not currently part of the Verify Result v2 schema reason-code enum; see `docs/CORE_2_MISSING_REFERENCE_SCHEMA_CONSIDERATION.md` for proposed semantics and boundaries.
